...
function App() {
  ...
  useEffect(() => {
    if (openModal) {
      const audio = new Audio("/src/components/MusicPlayer/assets/votay.mp3");
      audio.play();
    }
  }, [openModal]);
  ...
  return (
    <div>
      ...
      <Modal centered show={openModal} onHide={cancelModal} size="lg">
        ...
        <Row>
          ...
          <Col lg="3" md="auto">
            <div id="Tabs" className="mt-4">
              <Tabs defaultActiveKey="entries" className="nav-tabs-click">
                <Tab eventKey="entries" title="Entries" className="item-nav">
                  <ItemForm
                    items={items}
                    winners={winners}
