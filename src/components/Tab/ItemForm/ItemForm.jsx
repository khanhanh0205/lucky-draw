...
function ItemForm(props) {
  ...
  // let newList = [...value].map((item) =>
  //   item?.trim()
  //     ? item?.includes(bulletWithSpace)
  //       ? item
  //       : `${bulletWithSpace} ${item}`
  //     : null
  // );
  return (
    <div className="mt-10" style={{ background: "white" }}>
      <div className="content_inner">
        <SearchBar placeholder="Search..." data={value} />
        <textarea
          id="inputTextArea"
          className="form-control w-100 mt-2 p-10 list-item"
          value={value?.join("\n")}
     ...
     "
        >
          ...
          <button
            id="removeButton"
            className="btn-white btn btn-primary flex-lg-grow-1 "
            variant="light"
        ...
        <button
          id="updateButton"
          className="btn btn-primary disableElement w-100 mt-2 btn-white update-btn"
          onClick={() => {
